...
export const proseClass =
  "prose prose-lg max-w-none text-ink prose-headings:font-serif prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-ink prose-h2:text-2xl prose-p:text-soft prose-p:my-3 prose-a:text-clay prose-a:no-underline hover:prose-a:text-clay-dark prose-em:text-clay prose-em:font-medium prose-strong:text-ink prose-blockquote:border-clay prose-blockquote:font-serif prose-blockquote:text-ink prose-blockquote:not-italic prose-hr:border-line prose-li:text-soft prose-li:marker:text-clay";
